...
export const defaultTheme = {
	colors: {
		...
		'ikun-error-500': 'var(--ikun-rose-500)',
		'ikun-warning': 'var(--ikun-amber-400)',
		'ikun-warning-100': 'var(--ikun-amber-100)',
		'ikun-warning-500': 'var(--ikun-amber-500)',
		'ikun-info': 'var(--ikun-gray-400)',
		'ikun-info-100': 'var(--ikun-gray-100)',
		'ikun-info-500': 'var(--ikun-gray-500)',
