export const buttonShortcuts: Record<string, string> = {
	...
	'k-button--primary':
		'bg-ikun-primary-100 !text-ikun-primary border-ikun-primary-100',
	...
	'k-button--success':
		'bg-ikun-success-100 !text-ikun-success border-ikun-success-100',
	...
	'k-button--error':
		'bg-ikun-error-100 !text-ikun-error border-ikun-error-100',
	...
	'k-button--warning':
		'bg-ikun-warning-100 !text-ikun-warning border-ikun-warning-100',
