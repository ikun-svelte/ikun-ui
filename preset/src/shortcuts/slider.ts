export const sliderShortcuts: Record<string, string> = {
    ...
    'k-slider--button-wrapper': 'flex absolute bg-[transparent] w-9 h-9 top--3.75 translate-x-[-50%] items-center justify-center select-none line-height-[none]',
    'k-slider--button': 'inline-block w-5 h-5 border-ikun-main rounded-50% border-2 border-solid bg-ikun-white select-none'
};
