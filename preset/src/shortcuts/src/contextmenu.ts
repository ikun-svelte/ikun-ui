export const contextmenuShortcuts: Record<string, string> = {
	...
	'k-contextmenu-item-btn': 'k-reset-btn cursor-pointer',
	...
	'k-contextmenu-item__disabled__dark': 'dark:ikun:40:bg-ikun-main',
	'k-contextmenu-sub-menu__disable__dark': 'k-contextmenu-item__disabled__dark'
};
// [.dark > .k-contextmenu-item__disabled]: ikun:40:bg-ikun-main
