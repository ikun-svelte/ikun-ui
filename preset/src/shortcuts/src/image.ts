export const imageShortcuts: Record<string, string> = {
  ...
  'k-image__placeholder': 'bg-ikun-info-100 w-full h-full',
  'k-image__error': 'fcc text-14px align-middle text-ikun-tx-gr bg-ikun-info-100 text-ikun-info w-full h-full',
  'k-image__preview ': 'cursor-pointer',
};
