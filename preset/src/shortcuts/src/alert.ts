export const alertShortcuts = {
	...
	'k-alert--success__close-icon':
		'hover:(bg-ikun-success text-ikun-white b-rd-50%) active:(b-ikun-success k-btn-shadow--success)',
	...
	'k-alert--error__close-icon':
		'hover:(bg-ikun-error text-ikun-white b-rd-50%) active:(b-ikun-error k-btn-shadow--error)',
	...
	'k-alert--warning__close-icon':
		'hover:(bg-ikun-warning text-ikun-white b-rd-50%) active:(b-ikun-warning k-btn-shadow--warning)',
	...
	'k-alert--info__close-icon':
		'hover:(bg-ikun-info-500 text-ikun-white b-rd-50%) active:(b-ikun-info-500 k-btn-shadow--info)',
	...
	'k-alert--close__icon-color': 'color-ikun-stone-400',
