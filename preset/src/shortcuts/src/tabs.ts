export const tabsShortcuts: Record<string, string> = {
	...
	'k-tabs__nav--card': 'rounded-t border-solid border-ikun-bd-base n-bdb-1',
	'k-tabs__nav--border': 'rounded-tl border-solid border-ikun-bd-base n-bdb-1',
	...
	'k-tabs__add': 'ml-4px border-solid border-1 border-ikun-bd-base rounded cursor-pointer hover:text-ikun-main',
	...
	'k-tabs__nav-item--card': 'border-solid border-ikun-bd-base bdlb-1',
