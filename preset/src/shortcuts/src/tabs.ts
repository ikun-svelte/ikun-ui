export const tabsShortcuts: Record<string, string> = {
	...
	'k-tabs__add--wrap': 'flex-1 h-40px border-solid border-ikun-bd-base bdb-1 fec',
	'k-tabs__add--wrap--border': 'border-solid border-ikun-bd-base n-bdl-1 rounded-tr',
	'k-tabs__add':
	...
	'k-tabs__nav-item--active': 'text-ikun-main border-b-white bg-white',
