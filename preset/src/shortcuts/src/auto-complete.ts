export const autoCompleteShortcuts: Record<string, string> = {
	...
	'k-auto-complete--option__active': 'text-ikun-main',
	'k-auto-complete--option__fit': 'text-ellipsis overflow-hidden',
	// dark
	'k-auto-complete--option__dark': 'dark:text-ikun-white'
};
