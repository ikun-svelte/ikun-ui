import type { MapToken } from './map-token-types';
...
export interface AliasToken extends MapToken {
   ...
   */
  linkDecoration: CSS.CSSProperties['textDecoration'];
  /**
   * @nameZH 链接鼠标悬浮时文本装饰
   ...
   */
  linkHoverDecoration: CSS.CSSProperties['textDecoration'];
  /**
   * @nameZH 链接聚焦时文本装饰
   ...
   */
  linkFocusDecoration: CSS.CSSProperties['textDecoration'];
