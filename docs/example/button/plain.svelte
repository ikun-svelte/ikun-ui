...
<div class="flex items-center flex-wrap">
    <KButton type="info" cls="mx-2" plain={true}>
        info
    </KButton>
    <KButton type="error" cls="mx-2" plain={true}>
        error
    </KButton>
    <KButton type="success" cls="mx-2" plain={true}>
        success
    </KButton>
    <KButton type="primary" cls="mx-2" plain={true}>
        primary
    </KButton>
    <KButton type="warning" cls="mx-2" plain={true}>
        warning
    </KButton>
</div>
