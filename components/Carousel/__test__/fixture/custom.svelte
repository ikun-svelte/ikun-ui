...
<KCarousel style="height: 300px" count={6} initialIndex={0} autoplay={true}>
	<div style:height="280px" class="bg-orange-100 fcc"><h1>0</h1></div>
	<div style:height="280px" class="bg-orange-200 fcc"><h1>1</h1></div>
	<div style:height="280px" class="bg-orange-100 fcc"><h1>2</h1></div>
	<div style:height="280px" class="bg-orange-200 fcc"><h1>3</h1></div>
	<div style:height="280px" class="bg-orange-100 fcc"><h1>4</h1></div>
	<div style:height="280px" class="bg-orange-200 fcc"><h1>5</h1></div>
