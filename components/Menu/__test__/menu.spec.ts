...
import KMenuIconSlot from './fixture/icon-slot.svelte';
import KMenuLabelSlot from './fixture/label-slot.svelte';
...
import KMenuDanger from './fixture/danger.svelte';
import KMenuDisabled from './fixture/disabled.svelte';
...
describe('Test: KMenu', () => {
	...
	test('props: expandIcon & vertical', async () => {
		const instance = new KMenuExpandIcon({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		...
		await tick();
		await vi.advanceTimersByTimeAsync(300);
		expect(vEl.innerHTML.includes('i-carbon-logo-react')).toBeTruthy();
		expect(host.innerHTML).matchSnapshot();
	});

	test('props: expandIcon & inline', async () => {
		const instance = new KMenuExpandIcon({
			target: host
		});
		expect(instance).toBeTruthy();
	...
	test('props: expandIcon & horizontal', async () => {
		const instance = new KMenuExpandIcon({
			target: host
		});
		expect(instance).toBeTruthy();
	...
	test('slots: icon & vertical', async () => {
		const instance = new KMenuIconSlot({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
	...
	test('slots: icon & horizontal', async () => {
		const instance = new KMenuIconSlot({
			target: host
		});
		expect(instance).toBeTruthy();
	...
	test('slots: label & vertical', async () => {
		const instance = new KMenuLabelSlot({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
	...
	test('slots: label & horizontal', async () => {
		const instance = new KMenuLabelSlot({
			target: host
		});
		expect(instance).toBeTruthy();
...
describe('Test: KMenuItems', () => {
	...
	test('props: items - type & vertical', async () => {
		// @ts-ignore
		const instance = new KMenuDivider({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#divider_test_vertical');
		const vTrigger = vEl.querySelector('[slot="triggerEl"]');
		vTrigger.dispatchEvent(new Event('click', { bubbles: true }));
		await tick();
		await vi.advanceTimersByTimeAsync(300);
	...
	test('props: items - type & inline', async () => {
		// @ts-ignore
		const instance = new KMenuDivider({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const iEl = host.querySelector('#divider_test_inline');
		let iTrigger = iEl.querySelectorAll('[slot="triggerEl"]');
		iTrigger[0].dispatchEvent(new Event('click', { bubbles: true }));
		await tick();
		await vi.advanceTimersByTimeAsync(300);
	...
	test('props: items - type & horizontal', async () => {
		// @ts-ignore
		const instance = new KMenuDivider({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#divider_test_horizontal');
		const vTrigger = vEl.querySelector('[data-k-menu-h="1"]');
		vTrigger
			.querySelector('.k-menu-title-content-i')
			.dispatchEvent(new MouseEvent('click', { bubbles: true }));
	...
	test('props: items - icon & vertical', async () => {
		// @ts-ignore
		const instance = new KMenuIcon({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#icon_test_vertical');
		const vTrigger = vEl.querySelector('[slot="triggerEl"]');
		vTrigger.dispatchEvent(new Event('click', { bubbles: true }));
		await tick();
		await vi.advanceTimersByTimeAsync(300);
	...
	test('props: items - icon & inline', async () => {
		// @ts-ignore
		const instance = new KMenuIcon({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const iEl = host.querySelector('#icon_test_inline');
		let iTrigger = iEl.querySelectorAll('[slot="triggerEl"]');
		iTrigger[0].dispatchEvent(new Event('click', { bubbles: true }));
		await tick();
		await vi.advanceTimersByTimeAsync(300);
	...
	test('props: items - icon & horizontal', async () => {
		// @ts-ignore
		const instance = new KMenuIcon({
			target: host
		});
	...
	test('props: items - children & vertical', async () => {
		// @ts-ignore
		const instance = new KMenuChildren({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#children_test_vertical');
		const vTrigger = vEl.querySelector('[slot="triggerEl"]');
		vTrigger.dispatchEvent(new Event('click', { bubbles: true }));
		await tick();
		await vi.advanceTimersByTimeAsync(300);
	...
	test('props: items - children & inline', async () => {
		// @ts-ignore
		const instance = new KMenuChildren({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const iEl = host.querySelector('#children_test_inline');
		let iTrigger = iEl.querySelectorAll('[slot="triggerEl"]');
		iTrigger[0].dispatchEvent(new Event('click', { bubbles: true }));
		await tick();
		await vi.advanceTimersByTimeAsync(300);
	...
	test('props: items - children & horizontal', async () => {
		// @ts-ignore
		const instance = new KMenuChildren({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#children_test_horizontal');
		const vTrigger = vEl.querySelector('[data-k-menu-h="1"]');
		vTrigger
			.querySelector('.k-menu-title-content-i')
			.dispatchEvent(new MouseEvent('click', { bubbles: true }));
	...
	test('props: items - danger & vertical', async () => {
		// @ts-ignore
		const instance = new KMenuDanger({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#danger_test_vertical');
		const resEl = host.querySelector('#trigger_time');
		const vTrigger = vEl.querySelector('[slot="triggerEl"]');
		expect(resEl.innerHTML).toBe('0');
		vTrigger.dispatchEvent(new Event('click', { bubbles: true }));
	...
	test('props: items - danger & inline', async () => {
		// @ts-ignore
		const instance = new KMenuDanger({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#danger_test_inline');
		const resEl = host.querySelector('#trigger_time');
		let vTrigger = vEl.querySelectorAll('[slot="triggerEl"]');
		expect(resEl.innerHTML).toBe('0');
		vTrigger[0].dispatchEvent(new Event('click', { bubbles: true }));
	...
	test('props: items - danger & horizontal', async () => {
		// @ts-ignore
		const instance = new KMenuDanger({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#danger_test_horizontal');
		const resEl = host.querySelector('#trigger_time');
		const vTrigger = vEl.querySelector('[data-k-menu-h="1"]');
		expect(resEl.innerHTML).toBe('0');
		vTrigger.dispatchEvent(new Event('click', { bubbles: true }));
	...
	test('props: items - disabled & vertical', async () => {
		// @ts-ignore
		const instance = new KMenuDisabled({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#disabled_test_vertical');
		const resEl = host.querySelector('#trigger_time');
		const vTrigger = vEl.querySelector('[slot="triggerEl"]');
		expect(resEl.innerHTML).toBe('0');
		vTrigger.dispatchEvent(new Event('click', { bubbles: true }));
	...
	test('props: items - disabled & inline', async () => {
		// @ts-ignore
		const instance = new KMenuDisabled({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#disabled_test_inline');
		const resEl = host.querySelector('#trigger_time');
		let vTrigger = vEl.querySelectorAll('[slot="triggerEl"]');
		expect(resEl.innerHTML).toBe('0');
		vTrigger[0].dispatchEvent(new Event('click', { bubbles: true }));
		...
		vTrigger[5].dispatchEvent(new Event('click', { bubbles: true }));
		await tick();
		await vi.advanceTimersByTimeAsync(300);
		expect(resEl.innerHTML).toBe('1');
		expect(host.innerHTML).matchSnapshot();
	...
	test('props: items - disabled & horizontal', async () => {
		// @ts-ignore
		const instance = new KMenuDisabled({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#disabled_test_horizontal');
		const resEl = host.querySelector('#trigger_time');
		const vTrigger = vEl.querySelector('[data-k-menu-h="1"]');
		expect(resEl.innerHTML).toBe('0');
		vTrigger.dispatchEvent(new Event('click', { bubbles: true }));
		...
		vTriggerSub[4].dispatchEvent(new Event('click', { bubbles: true }));
		await tick();
		await vi.advanceTimersByTimeAsync(300);
		expect(resEl.innerHTML).toBe('1');
		expect(host.innerHTML).matchSnapshot();
	...
	test('events: titleClick & vertical', async () => {
		// @ts-ignore
		const instance = new KMenuTitleClick({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#title_click_test_vertical');
		const resEl = host.querySelector('#trigger_time');
		const vTrigger = vEl.querySelector('[slot="triggerEl"]');
		expect(resEl.innerHTML).toBe('0');
		vTrigger.dispatchEvent(new Event('click', { bubbles: true }));
	...
	test('events: titleClick & inline', async () => {
		// @ts-ignore
		const instance = new KMenuTitleClick({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const iEl = host.querySelector('#title_click_test_inline');
		const resEl = host.querySelector('#trigger_time');
		let iTrigger = iEl.querySelectorAll('[slot="triggerEl"]');
		expect(resEl.innerHTML).toBe('0');
		iTrigger[0].dispatchEvent(new Event('click', { bubbles: true }));
	...
	test('events: titleClick & horizontal', async () => {
		// @ts-ignore
		const instance = new KMenuTitleClick({
			target: host
		});
		expect(instance).toBeTruthy();
		await tick();
		const vEl = host.querySelector('#title_click_test_horizontal');
		const resEl = host.querySelector('#trigger_time');
		const vTrigger = vEl.querySelector('[data-k-menu-h="1"]');
		expect(resEl.innerHTML).toBe('0');
		vTrigger
