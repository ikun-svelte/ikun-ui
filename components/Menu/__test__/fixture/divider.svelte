...
<div class="w-full fsc">
	<KMenu mode="vertical" id="divider_test_vertical" triggerSubMenuAction="click" ctxKey="11">
		<KMenuItem {items} ctxKey="11" />
	</KMenu>
	<KMenu mode="inline" id="divider_test_inline" triggerSubMenuAction="click" ctxKey="22">
		<KMenuItem {items} ctxKey="22" />
	</KMenu>
	<KMenu mode="horizontal" id="divider_test_horizontal" triggerSubMenuAction="click" ctxKey="22">
		<KMenuItem {items} ctxKey="22" />
	</KMenu>
</div>
