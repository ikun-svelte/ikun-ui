...
<div class="w-full fsc">
	<KMenu mode="vertical" id="icon_test_vertical" triggerSubMenuAction="click" ctxKey="11">
		<KMenuItem {items} ctxKey="11" />
	</KMenu>
	<KMenu mode="inline" id="icon_test_inline" triggerSubMenuAction="click" ctxKey="22">
		<KMenuItem {items} ctxKey="22" />
	</KMenu>
	<KMenu mode="horizontal" id="icon_test_horizontal" triggerSubMenuAction="click" ctxKey="22">
		<KMenuItem {items} ctxKey="22" />
	</KMenu>
</div>
