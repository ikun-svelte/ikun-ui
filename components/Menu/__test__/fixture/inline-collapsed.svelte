...
<div class="w-full fsc">
	<KMenu mode="inline" inlineIndent={60} {inlineCollapsed} ctxKey="11">
		<KMenuItem {items} ctxKey="11" />
	</KMenu>
	<KMenu mode="vertical" inlineIndent={60} {inlineCollapsed} ctxKey="22">
		<KMenuItem {items} ctxKey="22" />
	</KMenu>
	<button on:click={handleInlineCollapsed}></button>
</div>
