...
<div class="w-full fsc">
	<KMenu mode="vertical" id="expand_icon_test_vertical" triggerSubMenuAction="click" ctxKey="11">
		<KMenuItem {items} ctxKey="11">
			<span slot="expandIcon"> 🎯 </span>
		</KMenuItem>
	</KMenu>
	<KMenu mode="inline" id="expand_icon_test_inline" triggerSubMenuAction="click" ctxKey="22">
	...
	<KMenu
		mode="horizontal"
		id="expand_icon_test_horizontal"
